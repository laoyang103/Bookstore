      ...
      <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
   			  ...
   			  <input type="hidden" id="id1" value="${notice.id }">
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="30">公告标题：</td>
					<td><input name="title" type="text" id="title" size="60" value="${notice.title}"></td>
                  </tr> 
				  <tr>
                    <td width="14%" >&nbsp;公告内容：</td>
                    <td width="86%">
                        <textarea id="content" name="content" cols="60" rows="15" class="textarea">${notice.content}</textarea></td>
                  </tr> 
                  <tr>
                    <td height="30">发布时间：
                    </td>
					<td>
					<input type="text" id="pdate" value="${notice.pdate}">
					</td>
                  ...
                  <tr>
					...
					<td><input type="text" id="edate" value="${notice.edate}"></td>
                  </tr>                   
                  <tr>
                    <td height="25" colspan="2" align="center">
                        <input name="Button" type="button" class="button" value="保存" onClick="alterNotice()">
                        &nbsp;                        

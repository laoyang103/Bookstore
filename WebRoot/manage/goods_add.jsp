...
<script type="text/javascript" src="../uploadify/onload.js"></script>
...
<body  onload="loadSuperCategorySelect()">
  ...
  <tr>
          ...
          <td valign="top">
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    ...
                    <td width="31%">&nbsp;
					  <select name="supertype" id="supertype" onChange="loadSubCategorySelect(this.value)">					  
                  ...
                  <tr>
                    ...
                    <td colspan="3">&nbsp;
                      <input title="请输入商品名" id="productname" type="text" class="Sytle_text" size="50">&nbsp;&nbsp;                    </td>
                    </tr>
                  <tr>
                    <td height="30">&nbsp;市场价格：</td>
                    <td>&nbsp;
                          <input title="请输入市场价格" id="normalprice" size="10" maxlength="8" type="text" class="Sytle_text">(元)
                    </td>
                    <td>&nbsp;商城价格：</td>
                    <td>&nbsp;
                          <input title="请输入商城价格" id="memberprice" size="10" maxlength="8"  type="text" class="Sytle_text">(元)
                    </td>
                  </tr>
                  <tr>   
                  <!--       
                    ...
                    <td>&nbsp;
                          <input name="rebate" type="text" class="Sytle_text" id="price">
                    </td>
                     -->           
                    <td>&nbsp;是否特价：</td>
                    <td><input name="sale" type="radio" class="noborder" value="1" checked>是<input name="sale" type="radio" class="noborder" value="0">否
                    </td>
                  </tr>                 
                  <tr>
	...
	<input type="file" name="file_upload" id="file_upload" />
                  ...
                  <tr>
                    ...
                    <td colspan="3"><span class="style5">&nbsp; </span>
                        <textarea title="请输入商品简介" name="introduce" cols="60" rows="5" class="textarea" id="introduce"></textarea></td>
                  </tr>
                  <tr>
                    <td height="38" colspan="4" align="center">
                        <input name="Button" type="button" class="button" value="保存" onClick="saveGood()">
&nbsp;                        

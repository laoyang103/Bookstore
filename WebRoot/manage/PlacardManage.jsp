...
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="/getBackNotices.do"></jsp:forward>
</c:if>
<html>
<head>
<title>后台管理</title>
                  ...
                  <td valign="top">                   
                    <table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF"> 
                      ...
                      <tr style="padding:5px;"> 
                        ...
                        <td align="center">${notice.pdate}</td>
                        <td align="center">${notice.edate}</td> 
                        <td align="center"><a href="../showNotice.do?id=${notice.id}"><img src="../images/modify.gif" width="15" height="15"></a></td>
                        <td align="center"><a href="../deleteNotice.do?id=${notice.id}"><img src="../images/del.gif" width="16" height="16"></a></td>
                      </tr>

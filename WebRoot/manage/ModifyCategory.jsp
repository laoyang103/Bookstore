...
<table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="../images/manage_center_modifytype.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
        ...
        <tr>
          <td valign="top">
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="30">分类名称：</td>
					<td><input title="请输入新的分类名称" name="name" type="text" id="typename" size="60"></td>
                  </tr> 
				  <tr>
                    <td width="16%" >描&nbsp;&nbsp;&nbsp;&nbsp;述</td>
                    <td width="84%" ><textarea id="desr" title="请输入新分类的说明信息"name="desr" cols="50" rows="5"></textarea></td>
                  </tr>
                  <tr align="center">
                    <td height="30" colspan="3">
                        <input type="button" class="button" value="修改" onclick="modifyCategory(${param.id},'${param.url }')">
                        &nbsp;                        

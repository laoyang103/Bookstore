...
<c:if test="${empty categorys}">
	<jsp:forward page="../showSuperCategorys.do"></jsp:forward>
</c:if>
<html>
<head>
<title>后台管理</title>
                    ...
                    <table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF"> 
                     ...
                     <c:forEach  items="${categorys}" var="category">
                      <tr style="padding:5px;"> 
                        <td height="20" align="center">${colum }.</td> 
                        <td align="center">${category.name}</td> 
                        <td align="center"><a href="../showSubCategorys.do?pid=${category.id}"><img src="../images/modify.gif" width="15" height="15"></a></td>
                        <td align="center"><a href="ModifyCategory.jsp?id=${category.id }&url=ParameterManage.jsp"><img src="../images/modify.gif" width="15" height="15"></a></td>
                        <td align="center"><a href="javascript:deleteCategory(${category.id},'ParameterManage.jsp');"><img src="../images/del.gif" width="16" height="16"></a></td>
                      </tr>

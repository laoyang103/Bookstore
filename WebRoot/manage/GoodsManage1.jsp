...
<c:if test="${empty categories}">
	<jsp:forward page="../getParentCategories.do?url=manage/GoodsManage1.jsp"></jsp:forward>
</c:if>
<html>
<head>
<title>后台管理</title>
      ...
      <tr>
        <td valign="top" background="./images/manage_03.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="70%">
	            <!--搜索框-->
			<form name="search" action="./searchProducts4Admin.do">
			...
			<tr>
			  <td width="85%">&nbsp;商品类别：
				...
				<input name="name" title="请输入想要找的商品" type="text" class="txt_grey" size="15">                  </td>
      ...
      <table width="98%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
			...
			<c:forEach items="${searchresultproducts}" var="product">
              <tr id="${product.id}" style="padding:5px;">
                <td align="center">${colum }.</td>
                <td height="20" align="center"><a href="./showProductDetail4Admin.do?id=${product.id }">${product.name }</a></td>                                
                ...
                <td align="center"><img style="cursor:hand" onclick="addProductAmount4SearchResult(${product.id})" src="./images/add.gif" width="16" height="16"></td>
                <td align="center"><a href="modifyProduct.do?productid=${product.id }"><img src="./images/modify.gif" width="15" height="15"></a></td>
                <td align="center"><img style="cursor:hand" onclick="deleteProduct4SearchResult(${product.id})" src="./images/del.gif" width="16" height="16"></td>
            </tr>

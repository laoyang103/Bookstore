...
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="getNotices.do?url=placard_detail.jsp"></jsp:forward>
</c:if>

<c:if test="${empty categories}">
	<jsp:forward page="getParentCategories.do?url=placard_detail.jsp"></jsp:forward>
</c:if>
<c:if test="${empty products}">
   <jsp:forward page="getProductsBySum.do?url=placard_detail.jsp"></jsp:forward>
</c:if>
<html>
<head>
<title>奋斗电子商城</title>
            ...
            <tr valign="top">
              <td height="134" align="center">
                  <table width="96%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>                     
                      <td width="95%" height="27" class="font1">${notice.title }</td>
                    </tr>
                    <tr>                      
                      <td height="27">&nbsp;&nbsp;${notice.content }</td>
                    </tr>
                    <tr>                      
                      <td height="27">发布日期：${notice.pdate }<br>失效日期：${notice.edate }</td>
                    </tr>
                    <tr>

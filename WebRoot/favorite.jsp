...
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="getNotices.do?url=favorite.jsp"></jsp:forward>
</c:if>

<c:if test="${empty categories}">
	<jsp:forward page="getParentCategories.do?url=favorite.jsp"></jsp:forward>
</c:if>
<c:if test="${empty products}">
   <jsp:forward page="getProductsBySum.do?url=favorite.jsp"></jsp:forward>
</c:if>
<html>
<head>
<title>奋斗电子商城</title>
...
<c:if test="${not empty favorites }">  
                  <table width="96%" height="30"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                    ...
                    <tr>
                      <td width="45%" align="center"><img src="images/goods/${favorite.img}.jpg" width="150" height="100"></td>
                      <td width="25%"><a href="showProductDetail.do?id=${favorite.id }">${favorite.name}</a></td>
                      <td height="15">${favorite.memberprice}</td>
                      <td width="15%" align="center">
						 <input type="button" class="button" onClick="addCart(${favorite.id})" value="购买">						 
					  </td>
                    </tr>
                    </c:forEach>
                  </table>

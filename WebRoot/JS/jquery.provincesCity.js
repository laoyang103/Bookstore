...
$.fn.ProvinceCity = function(){
	var _self = this;
	//定义3个默认值
	_self.data("province",["江西", "江西"]);
	_self.data("city1",["南昌", "南昌"]);
	_self.data("city2",["南昌市", "南昌市"]);
	//插入3个空的下拉框
	_self.append("<select id='province'></select>省&nbsp&nbsp&nbsp");
	_self.append("<select id='city'></select>市&nbsp&nbsp&nbsp");
	_self.append("<select id='area'></select>区&nbsp&nbsp&nbsp");
	//分别获取3个下拉框

...
<c:if test="${empty ads}">
	<jsp:forward page="getSource.do?url=index.jsp"></jsp:forward>
</c:if>
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="getNotices.do?url=index.jsp"></jsp:forward>
</c:if>

<c:if test="${empty indexspecialproducts}">
   <jsp:forward page="showIndexSpecialProducts.do"></jsp:forward>
</c:if>

<c:if test="${empty products}">
   <jsp:forward page="getProductsBySum.do?url=index.jsp"></jsp:forward>
</c:if>
<c:if test="${empty newproducts}">
   <jsp:forward page="getNewProduct.do?url=index.jsp"></jsp:forward>
</c:if>
<c:if test="${empty categories}">
	<jsp:forward page="getParentCategories.do?url=index.jsp"></jsp:forward>
</c:if>
...
<!--fancyBox全屏图片/视频/iframe -->
<script type="text/javascript" src="fancybox/jquery.fancybox.pack.js?v=2.1.1"></script>
<script type="text/javascript" src="fancybox/onload.js"></script>
...
<c:forEach items="${indexspecialproducts }" var="indexspecialproduct">
                  <td width="49%" height="162" valign="top">
				  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="95" align="center"><a href="images/goods/${indexspecialproduct.img}.jpg"><img src="images/goods/${indexspecialproduct.img}.jpg" width="150" height="88"></a></td>
                    </tr>
                    <tr>
                      <td height="22" align="center" class="font2"><a href="showProductDetail.do?id=${indexspecialproduct.id }" class="iframe">${indexspecialproduct.name}</a></td>
                    </tr>
                    <tr>
                      <td height="20" align="center" style="text-decoration:line-through;">市场价：￥${indexspecialproduct.normalprice} </td>
                    </tr>
                    <tr>
                      <td height="20" align="center" style="color:#FF0000">商城价：￥${indexspecialproduct.memberprice}</td>
                    </tr>
                    <tr>
                      <td height="22" align="center">
                      <input type="button" class="button" onClick="addCart(${indexspecialproduct.id})" value="购买">
                      &nbsp;<input type="button" class="button" value="收藏" onclick="addFavorite(${indexspecialproduct.id})">
                      </td>
                    </tr>
                  </table>
				  </td>
...
<c:forEach items="${newproducts}" var="newproduct">				
				<table width="100%" height="79"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                  <tr>
                    <td width="33%" height="95" rowspan="2" align="center"><a href="images/goods/${newproduct.img }.jpg"><img src="images/goods/${newproduct.img }.jpg" width="99" height="61"></a></td>
                    <td width="67%" class="font2"><a href="showProductDetail.do?id=${newproduct.id }" class="iframe">${newproduct.name }</a></td>
                  </tr>                  
                  <tr>
                    <td>￥${newproduct.memberprice } <input type="button" class="button" onClick="addCart(${newproduct.id })" value="购买">
                      &nbsp;<input type="button" class="button" value="收藏" onclick="addFavorite(${newproduct.id })">
					</td>
                  </tr>
                </table>
</c:forEach>                
		 ...
		 <!--右侧框架-->
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${ads}" var="ad">
              <tr>
                <td height="70" align="center"><img id="1" src="images/${ad.img}.jpg" width="150" height="60"></td>
              </tr>
            </c:forEach> 
            </table>
		 <!--右侧框架结束-->

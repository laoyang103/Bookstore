...
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="getNotices.do?url=order.jsp"></jsp:forward>
</c:if>
<c:if test="${empty products}">
   <jsp:forward page="getProductsBySum.do?url=order.jsp"></jsp:forward>
</c:if>
<html>
<head>
<title>奋斗电子商城</title>
...
<script type="text/javascript" src="jqpagination/onload.js"></script>

...
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="getNotices.do?url=search_deal.jsp"></jsp:forward>
</c:if>

<c:if test="${empty categories}">
	<jsp:forward page="getParentCategories.do?url=search_deal.jsp"></jsp:forward>
</c:if>
<c:if test="${empty products}">
   <jsp:forward page="getProductsBySum.do?url=search_deal.jsp"></jsp:forward>
</c:if>
            ...
            <tr valign="top">
              <td height="134" align="center">
                 <table width="90%" height="23"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                    <tr>
                      <td height="23"> [${supername}]&nbsp;查询关键字：[${name}]</td>
                      </tr>
                  </table>
                  <c:if test="${not empty searchproducts }">
			      ...
			      <table width="90%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">			        
                    <tr>
                      <td width="5%" rowspan="4" align="center" valign="top">${colum }.</td>
                      <td width="45%" height="95" rowspan="4" align="center"><img src="images/goods/${searchproduct.img }.jpg" width="184" height="119"></td>
                      <td width="50%" height="27" class="font2"><a href="showProductDetail.do?id=${searchproduct.id }">${searchproduct.name}</a></td>
                    </tr>
                    <tr>
                      <td height="27">￥${searchproduct.normalprice}</td>
                    </tr>
                    <tr>
                      <td height="27"><c:choose>
                          <c:when test="${searchproduct.ncount > 0}">
                                                                现在有货</c:when>                          
                          <c:otherwise>缺货<br> </c:otherwise>
                         </c:choose></td>
                    </tr>
                    <tr>
                      <td><input type="button" class="button" value="购买" onclick="addCart(${searchproduct.id})">&nbsp;&nbsp;
						 <input type="button" class="button" value="收藏" onclick="addFavorite(${searchproduct.id})">
				      </td>
                    </tr>
                  </table>

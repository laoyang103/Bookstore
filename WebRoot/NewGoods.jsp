...
<c:if test="${empty ads}">
	<jsp:forward page="getSource.do?url=NewGoods.jsp"></jsp:forward>
</c:if>
<c:if test="${empty notices && empty isNull }">
     <jsp:forward page="getNotices.do?url=NewGoods.jsp"></jsp:forward>
</c:if>
<c:if test="${empty products}">
   <jsp:forward page="getProductsBySum.do?url=NewGoods.jsp"></jsp:forward>
</c:if>
<c:if test="${empty newproducts}">
   <jsp:forward page="./getNewProduct.do?url=NewGoods.jsp"></jsp:forward>
</c:if>
...
value="搜索"></td>
      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table width="594"  border="0" cellspacing="0" cellpadding="0" height="923">
            <tr>
              <td height="70" background="images/center_newgoods.gif">&nbsp;</td>
            </tr>
            <tr valign="top">
              <td height="134" align="center">
<c:forEach  items="${newproducts}" var ="newproduct" >
			       <table width="571" height="178"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>
                      <td width="37%" height="95" rowspan="5" align="center"><img src="images/goods/${newproduct.img }.jpg" width="150" height="100"></td>
                      <td width="63%" height="27" class="font2"><a href="showProductDetail.do?id=${newproduct.id }">${newproduct.name} </a></td>
                    </tr>
                    <tr>
                      <td height="27">￥${newproduct.normalprice}</td>
                    </tr>
                    <tr>
                      <td height="27"><c:choose>
                          <c:when test="${newproduct.ncount > 0}">
                                                                现在有货</c:when>                          
                          <c:otherwise>缺货<br> </c:otherwise>
                         </c:choose> </td>
                    </tr>
                    <tr>
                      <td><input type="button" class="button" value="购买" onclick="addCart(${newproduct.id})">&nbsp;&nbsp;
